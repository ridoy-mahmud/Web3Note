...
const ImageAttachments = ({
  ...
  const pendingImage = images.find((img) => img.id === pendingDeleteId);
  ...
  return (
    <div className="space-y-2">
            ...
            >
              ...
              {!readonly && (
                <button
                  ...
                  className="absolute top-1 right-1 p-1 rounded-full bg-background/80 text-destructive opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity"
      ...
      <DeleteConfirmDialog
        ...
        description={
          pendingImage
            ? `\"${pendingImage.name}\" will be removed from this note.`
            : "This image will be removed from this note."
        }
